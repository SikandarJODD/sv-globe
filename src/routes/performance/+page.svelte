...
<div class="w-full max-w-3xl space-y-10 pb-8">
	...
	>
		...
		<div class="space-y-4">
			...
			<p class="max-w-2xl font-figtree text-base leading-7 text-muted-foreground">
				Before increasing samples, reduce scene cost somewhere cheaper:
				<Highlight>fewer markers, fewer arcs, and less per-frame data churn</Highlight> usually buys you
				more headroom than raising the map detail.
			</p>
		</div>
	</section>
